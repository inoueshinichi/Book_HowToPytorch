...
def findPositiveSamples(datasetdir:str, start_ndx=0, limit=100):
    ds = LunaDataset(datasetdir=datasetdir)
...
def showCandidate(datasetdir:str, series_uid, batch_ndx=None, **kwargs):
    ds = LunaDataset(datasetdir=datasetdir, series_uid=series_uid, **kwargs)
